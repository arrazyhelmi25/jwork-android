...
/**
 * Kelas JobBatalRequest, berfungsi untuk memberikan atau mengubah status dari suatu invoice menjadi dibatalkan (Cancelled).
...
public class JobBatalRequest extends StringRequest {
    ...
    /**
     * Constructor JobBatalRequest, berfungsi untuk mengubah status dari invoice berdasarkan input parameter yang diberikan.
     *
